...
class FrienddbsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frienddb" do
    assert_difference("Frienddb.count") do
      post frienddbs_url, params: { frienddb: { email: @frienddb.email, first_name: @frienddb.first_name, last_name: @frienddb.last_name, twitter: @frienddb.twitter } }
    end
  ...
  test "should update frienddb" do
    patch frienddb_url(@frienddb), params: { frienddb: { email: @frienddb.email, first_name: @frienddb.first_name, last_name: @frienddb.last_name, twitter: @frienddb.twitter } }
